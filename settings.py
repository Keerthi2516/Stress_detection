...
ROOT_URLCONF = 'real_time_personalized_physiologically.urls'
...
WSGI_APPLICATION = 'real_time_personalized_physiologically.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'real_time_personalized_physiologically',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
