"""real_time_personalized_physiologically URL Configuration
...
from real_time_personalized_physiologically import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Stress_Detection_Status/$', remoteuser.Predict_Stress_Detection_Status, name="Predict_Stress_Detection_Status"),
    ...
    url(r'^View_Prediction_Of_Stress_Detection_Status_Ratio/$', serviceprovider.View_Prediction_Of_Stress_Detection_Status_Ratio, name="View_Prediction_Of_Stress_Detection_Status_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Stress_Detection_Status/$', serviceprovider.View_Prediction_Of_Stress_Detection_Status, name="View_Prediction_Of_Stress_Detection_Status"),
